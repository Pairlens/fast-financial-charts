# Fast Financial Charts: API Guide

The complete configuration and extension reference for `@pairlens/fast-financial-charts`. For the overview, install, and quick start, see the [README](../README.md). For the full indicator list with parameters, see [INDICATORS.md](../INDICATORS.md).

- [Package format](#package-format)
- [Chart types](#chart-types)
- [Price scale modes](#price-scale-modes)
- [Time scale configuration](#time-scale-configuration)
- [Crosshair modes](#crosshair-modes)
- [Watermark](#watermark)
- [Series annotations](#series-annotations)
- [Multi-series and compare modes](#multi-series-and-compare-modes)
- [Multi-pane management](#multi-pane-management)
- [Built-in indicators](#built-in-indicators-90)
- [Built-in drawing tools](#built-in-drawing-tools)
- [Interaction model](#interaction-model)
- [Theming](#theming)
- [Localization](#localization)
- [Headless composition](#headless-composition-shadcn-friendly)
- [Controlled vs uncontrolled state](#controlled-vs-uncontrolled-state)
- [Extensibility: indicators and drawings](#extensibility-indicators-and-drawings)
- [Coordinate conversion APIs](#coordinate-conversion-apis)
- [Data read-back APIs](#data-read-back-apis)
- [AI / MCP integration](#ai--mcp-integration)
- [Tree-shakeable entry points](#tree-shakeable-entry-points)
- [Performance recommendations](#performance-recommendations-for-consumers)
...
The package ships prebuilt JavaScript and type declarations. No loader, transpiler, or bundler configuration is required. Every entry point resolves to both ESM and CommonJS with matching `.d.ts`:
